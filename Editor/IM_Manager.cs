...
{
    [MenuItem("VMS DRAGON /IM - Manager")]
    static void Init()
    {
    ...
    int CometarioIdCometarioIdioma = 1;
    int[] attributeName;
    int[] attributeValue;
            ...
            if (showItem)
            {
                ...
                try
                {
                    ...
                    GUILayout.Space(10);
                                ...
                                inventoryItemList.itemList[inventoryItemList.itemList.Count - 1].ItemDescrição[0] = EditorGUILayout.TextArea(inventoryItemList.itemList[inventoryItemList.itemList.Count - 1].ItemDescrição[0], GUILayout.Width(position.width - 180), GUILayout.Height(70));
                                inventoryItemList.itemList[inventoryItemList.itemList.Count - 1].ItemDescrição[1] = EditorGUILayout.TextArea(inventoryItemList.itemList[inventoryItemList.itemList.Count - 1].ItemDescrição[1], GUILayout.Width(position.width - 180), GUILayout.Height(70));
                                
                                 inventoryItemList.itemList[inventoryItemList.itemList.Count - 1].ItemDescrição[2] = EditorGUILayout.TextArea(inventoryItemList.itemList[inventoryItemList.itemList.Count - 1].ItemDescrição[2], GUILayout.Width(position.width - 180), GUILayout.Height(70));
                    ...
                    inventoryItemList.itemList[inventoryItemList.itemList.Count - 1].TipoDoItem = (ItemType)EditorGUILayout.EnumPopup("Item Type", inventoryItemList.itemList[inventoryItemList.itemList.Count - 1].TipoDoItem, GUILayout.Width(position.width - 33));                                      //the itemtype which you want to have can be selected with the enumpopup
                    ...
                    inventoryItemList.itemList[inventoryItemList.itemList.Count - 1].Raridade = EditorGUILayout.IntSlider("Rarity", inventoryItemList.itemList[inventoryItemList.itemList.Count - 1].Raridade, 0, 100);
                ...
                for (int i = 1; i < inventoryItemList.itemList.Count; i++)                      //get through all items which are there in the itemdatabase
                {
                    try
                    {
                        ...
                        if (manageItem[i])                                                                                                      //if you press on it you get this
                        {
                            ...
                            inventoryItemList.itemList[i].ItemDescrição[0] = EditorGUILayout.TextArea(inventoryItemList.itemList[i].ItemDescrição[0], GUILayout.Width(position.width - 195), GUILayout.Height(70));     //Text area for the itemDesc
                             inventoryItemList.itemList[i].ItemDescrição[1] = EditorGUILayout.TextArea(inventoryItemList.itemList[i].ItemDescrição[1], GUILayout.Width(position.width - 195), GUILayout.Height(70)); 
                            inventoryItemList.itemList[i].ItemDescrição[2] = EditorGUILayout.TextArea(inventoryItemList.itemList[i].ItemDescrição[2], GUILayout.Width(position.width - 195), GUILayout.Height(70)); 
                            ...
                            inventoryItemList.itemList[i].TipoDoItem = (ItemType)EditorGUILayout.EnumPopup("Item Type", inventoryItemList.itemList[i].TipoDoItem, GUILayout.Width(position.width - 45));                                      //the itemtype which you want to have can be selected with the enumpopup
                            ...
                            inventoryItemList.itemList[i].Raridade = EditorGUILayout.IntSlider("Rarity", inventoryItemList.itemList[i].Raridade, 0, 100);
